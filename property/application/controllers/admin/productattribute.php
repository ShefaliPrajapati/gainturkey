...
class Productattribute extends MY_Controller {
	...
	public function display_product_subattribute_list(){
		...
		if ($this->checkLogin('A') == ''){
			...
			$this->load->view('admin/productattribute/display_product_subattribute_list',$this->data);
		}
	}
	...
	public function add_product_subattribute_form(){
		if ($this->checkLogin('A') == ''){
			...
			$this->load->view('admin/productattribute/add_product_subattribute',$this->data);
		}
	}
	...
	public function insertSubAttribute(){
		if ($this->checkLogin('A') == ''){
			...
			if ($duplicate_name->num_rows() > 0){
				...
				redirect('admin/productattribute/add_product_subattribute_form/');
			}
			$seourl = url_title($attr_name,'',TRUE);
			...
			redirect('admin/productattribute/display_product_subattribute_list');
		}
	}
...
/**
	...
	public function edit_subattribute_form(){
		if ($this->checkLogin('A') == ''){
			...
			if ($this->data['attribute_details']->num_rows() == 1){
				$this->load->view('admin/productattribute/edit_product_subattribute',$this->data);
			}else {
				redirect('admin_ror');
			}
		}
