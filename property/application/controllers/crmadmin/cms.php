...
class Cms extends MY_Controller {
     ...
     */
   	public function index(){	
		if ($this->checkLogin('CA') == ''){
			...
			redirect('crmadmin/cms/display_cms');
		}
	}
	...
	public function display_cms(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/cms/display_cms',$this->data);
		}
	}
	...
	public function add_cms_form(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/cms/add_cms',$this->data);
		}
	}
	...
	public function add_subpage_form(){
		if ($this->checkLogin('CA') == ''){
			...
			if ($this->data['cms_details']->num_rows() > 0){
				$this->load->view('crmadmin/cms/add_sub_page',$this->data);
			}else {
	...
	public function edit_cms_form(){
		if ($this->checkLogin('CA') == ''){
			...
			if ($this->data['cms_details']->num_rows() == 1){
				...
				$this->load->view('crmadmin/cms/edit_cms',$this->data);
			}else {
				redirect('deals_crm');
			}
		}
...
/* End of file cms.php */
/* Location: ./application/controllers/crmadmin/cms.php */