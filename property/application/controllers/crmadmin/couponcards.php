...
class Couponcards extends MY_Controller { 
     ...
     */
   	public function index(){	
		if ($this->checkLogin('CA') == ''){
			...
			redirect('crmadmin/couponcards/display_couponcards');
		}
	}
	...
	public function display_couponcards(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/couponcards/display_couponcards',$this->data);
		}
	}
	...
	public function add_couponcard_form(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/couponcards/add_couponcard',$this->data);
		}
	}
	/**
	 * 
	...
	public function edit_couponcard_form(){
		if ($this->checkLogin('CA') == ''){
			...
			if ($this->data['couponcard_details']->num_rows() == 1){
				$this->load->view('crmadmin/couponcards/edit_couponcard',$this->data);
			}else {
				redirect('deals_crm');
			}
		}
...
/* Location: ./application/controllers/crmadmin/couponcards.php */