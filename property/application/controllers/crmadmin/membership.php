...
class Membership extends MY_Controller {
     ...
     */
   	public function index(){	
		...
		if ($this->checkLogin('CA') == ''){
			...
			redirect('crmadmin/membership/display_membership');
		}
	}
	...
	public function display_membership_dashboard(){
		...
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/membership/display_membership_dashboard',$this->data);
		}
	}
	/**
	 * 
	...
	public function membership_list(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/membership/membership_llist',$this->data);
		}
	}
	/**
	 * 
	...
	//		echo "<pre>";print_r($this->data['productList']->result());die;
			$this->load->view('crmadmin/membership/display_membership',$this->data);
		}
	}
	...
	public function add_membership_form(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/membership/add_membership',$this->data);
		}
	}
	...
	public function edit_membership_form(){
		if ($this->checkLogin('CA') == ''){
			...
			if ($this->data['product_details']->num_rows() == 1){
				...
				$this->load->view('crmadmin/membership/edit_product',$this->data);
			}else {
				redirect('deals_crm');
			}
		}
	...
	public function view_membership(){
		if ($this->checkLogin('CA') == ''){
			...
			if ($this->data['product_details']->num_rows() == 1){
				...
				$this->load->view('crmadmin/membership/view_product',$this->data);
			}else {
				redirect('deals_crm');
			}
		}
...
/* Location: ./application/controllers/crmadmin/membership.php */