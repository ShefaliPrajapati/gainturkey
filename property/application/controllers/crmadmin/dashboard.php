...
class Dashboard extends MY_Controller {
	...
	public function admin_dashboard()
	{
		...
		if ($this->checkLogin('CA') == ''){
			...
			/* get total Contact count start */
			
			$subscriberTableName = CONTACT;
			$subscriberFieldName = 'id';
			$subscriberWhereCondition = array();			

			$getTotalContactCount = $this->dashboard_model->getCountDetails($subscriberTableName,$subscriberFieldName,$subscriberWhereCondition);
			/* get total Contact count end*/
			...
			//$this->load->view('crmadmin/giftcards/display_giftcards_dashboard',$this->data);
