					...
					?>
                     ...
                     <div id="tab1">
						<ul>
                          ...
                          <li>
                            <div class="form_grid_12">
                              <label class="field_title" for="valid_date">Free For : <input type="radio" name="valide" <?php if($product_details->row()->option_type=='Free'){echo 'checked="checked"';} ?> value="free"  id="valide" /> 
                              Valid For : <input type="radio" name="valide" value="valide" <?php if($product_details->row()->option_type=='Valide'){echo 'checked="checked"';} ?> id="valide" /></label>
                              <div class="form_input">
	 						...
	 						<!--<li>
								<div class="form_grid_12">
								<label class="field_title" for="excerpt">Short Description</label>
								<div class="form_input">
                      ...
                      <ul>
	                      <li>
								<div class="form_grid_12">
									<label class="field_title" for="product_image"> Image</label>
									<div class="form_input">
