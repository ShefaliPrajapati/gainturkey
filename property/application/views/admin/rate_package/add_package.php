			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Add New Rental Rate Package</h6>
                        <div id="widget_tab">
              				<ul>
                    	...
                    	<div id="tab1">
	 						<ul>
								...
								<div class="form_grid_12">
                                    ...
                                    <input name="name" style=" width:295px" id="name" value="" type="text" tabindex="1" class="required tipTop" title="Please enter the package name"/>
									</div>
								</div>
								</li>
