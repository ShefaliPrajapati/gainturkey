...
-->             				 </ul>
					...
					<div class="widget_content">
					 ...
					 <?php 
						...
						echo form_open_multipart('admin/product/edit_source_info',$attributes);
             ...
             <li>
                <div class="form_grid_12">
                  ...
                  <div class="form_input">
                    ...
                    <option value="<?php echo $SourDets->s_email; ?>" <?php if($SourDets->s_email == $s_email){ echo 'selected="selected"'; }?>><?php echo $SourDets->s_email; ?></option>
                    <?php } ?>
                    </select>
              ...
              <li>
               ...
               <li>
                <div class="form_grid_12">
                  ...
                  <div class="form_input">
                    <input name="s_city" id="s_city" value="<?php echo $s_city;?>" type="text" tabindex="1" class="large tipTop" title="Please enter sourcer city"/>
              ...
              <li>
                <div class="form_grid_12">
                  ...
                  <div class="form_input">
                    ...
                    <option value="<?php echo $ManagDets->m_email; ?>" <?php if($ManagDets->m_email == $m_email){ echo 'selected="selected"';} ?>><?php echo $ManagDets->m_email; ?></option>
                    <?php } ?>
                    </select>
