...
<div class="left_detail">
   ...
   <?php foreach($productImages->result() as $Image)
   			{
			?> 
            <li><img src="<?php echo base_url();?>images/product/<?php if($Image->product_image != '') echo $Image->product_image; else echo 'no_image.jpg'; ?>"  alt="<?php echo $Image->imgtitle;?>" data-description=" " data-thumb="<?php echo base_url();?>images/product/thumb/<?php if($Image->product_image != '') echo $Image->product_image; else echo 'no_image.jpg'; ?>" /></li>
            <?php } ?>
