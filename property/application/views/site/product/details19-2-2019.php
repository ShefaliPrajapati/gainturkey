...
<input type="hidden" name="addressVal" id="addressVal" value="Return on Rentals <?php echo '<br>' . $productAddress->row()->address . '<br>' . $productAddress->row()->city . '<br>' . $productAddress->row()->state; ?>"  />
<input type="hidden" name="lat" id="lat" value="<?php echo $lat; ?>"  />
<input type="hidden" name="lng" id="lng" value="<?php echo $lng; ?>"  />

<script src="https://maps.google.com/maps/api/js?sensor=false" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>js/gmap3.min.js" type="text/javascript"></script>
<script type="text/javascript">
    function initialize_map() {
        ...
        //alert(latval+' '+lngval);
        var img = '<div style="margin:5px 0 0 0;"><div style="width:180px;height:110px;float:left;">' + addrval + '</div><div style="float:right;"></div></div>';
        $('#testmap').gmap3(
                {action: 'init',
                    options: {
...
// Calculate total gross income
        ...
        <div id="details" class="calc_popup"  style="display:none;">
    ...
    <div class="calculatorPopUp">
        ...
        <div id="brochure-details" class="calc_popup"  style="display:none;"> 
            <div id="draggable1" class="ui-widget-content brochure-content"> 
                ...
                <div class="calculatorPopUpMain datatable  " >
                    ...
                    <h2>Home Brochure Generator Form</h2>
                    <h3><sup>*</sup>Required Field</h3>

                    <div class="clear"></div>
                    <form name="brochureform" id="brochureform" method="post" enctype="multipart/form-data" action="site/product/brochure_download">  
                        <!--popupFormEnclose starts here-->
                        <div class="popupFormEnclose width100p">

                            <!--popupFormBox starts here-->
                            <div class="popupFormBox width100p">
                                <label>Business Name:</label>
                                <input type="text" name="bbname" id="bbname"  value="" /><sup>*</sup>
                                <span class="err_msg" id="bbnameErr"></span> 
                            </div>
                            <!--popupFormBox ends here-->
                            ...
                            <div class="popupFormBox width100p">
                                ...
                                <input type="text" name="bfname" id="bfname"  class="" /><sup>*</sup>
                                <span class="err_msg" id="bfnameErr"></span>                        
                            </div>
                            <!--popupFormBox ends here-->
                            ...
                            <div class="popupFormBox width100p">
                                ...
                                <input type="text" name="blname" id="blname"  /><sup>*</sup>
                                <span class="err_msg" id="blnameErr"></span> 
                            ...
                            <div class="popupFormBox width100p">
                                ...
                                <label>Phone</label>
                                <input type="text"  name="bphoneno" id="bphoneno"  /><sup>*</sup>
                                <span class="err_msg" id="bphonenoErr"></span>
                            ...
                            <div class="popupFormBox width100p">
                                ...
                                <label>Sale Price:</label>  
                                $<input type="text"  name="bsaleprice" id="bsaleprice" value="<?php echo number_format($productDetails->row()->event_price); ?>"  />
                                <span class="err_msg" id="bsalepriceErr"></span>
                            ...
                            <div class="popupFormBox width100p">
                                ...
                                <textarea class="brochure_input" name="bdescription" id="bdescription"></textarea>                                             
                            </div>

                            <div class="popupFormBox width100p">
                                <input type="hidden" name="bpropid" id="bpropid" value="<?php echo $productDetails->row()->property_id; ?>" >
                                <input type="hidden" name="b_row_id" id="b_row_id" value="<?php echo $productDetails->row()->id; ?>" >
                                <input type="button" class="brochure-submit" value="Submit" onclick="brochureValidation();"  />                                            
                            </div>
    ...
    <div class="detail_titleuse">
        ...
        <h2><?php echo $productAddress->row()->address . ', ' . $productAddress->row()->city . ', ' . str_replace('-', ' ', $productAddress->row()->state) . ' ' . $productAddress->row()->post_code; ?><a class="download-brochure-btn" id="edit_options" onclick="return displayfunction('brochure-details', 'brochure-details_parent');" href="javascript:void(0);">Download Brochure</a></h2>
    ...
    <div class="left_detail">
        ...
        <div class="scroll_product">
            <ul id="myGallery">
                <?php
                foreach ($productImages->result() as $Image) {
                    ?> 
    ...
    <div class="right_detail">
        ...
        <div class="inside_right">
            ...
            <?php
            if ($this->session->userdata('fc_session_group') == 'Admin') {
                ?>
                <form id="buy_property" name="buy_property" method="post" action="reservation/<?php echo $productDetails->row()->id; ?>">
                    ...
                    <input type="submit" name="buy" class="buyer_btn <?php
                    if ($productDetails->row()->property_status == 'Sold') {
                        echo 'clicksold';
                    } else if ($productDetails->row()->property_status == 'Reserved') {
                        echo 'clickreserved';
                    }
                    ?>" value="BUY NOW">
                </form>
            ...
            <div class="split_detail1">
                <ul class="splitdetai_list">
                    <li><p style="color:#036301; font-size:15px;">Property Details </p></li>
                    ...
                    <?php if ($productDetails->row()->property_sub_type != 0) {
                        ?>
                        <li><p>TYPE: </p><span> <?php
                                foreach ($PropertySubType->result() as $row1) {
                        ...
                        ?>
                        <li><p>TYPE: </p><span> <?php
                                foreach ($PropertyType->result() as $row) {
            ...
            <div class="split_detail2">
                <ul class="splitdetai_list2">
                    <li><p style="color:#036301; font-size:15px;">Cash Flow analysis</p></li>
        ...
        <div class="map_con">
            ...
            <div id="testmap" class="location_map gmap3"></div>
...
<script type="text/javascript">
    ...
    function brochureValidation() {
        ...
        if ($('#bbname').val() == '') {
            $('#bbnameErr').html('This field is required');
            return false;
        }

        if ($('#bfname').val() == '') {
            $('#bfnameErr').html('This field is required');
            return false;
        }

        if ($('#blname').val() == '') {
            $('#blnameErr').html('This field is required');
            return false;
        }

        if ($('#bphoneno').val() == '') {
            $('#bphonenoErr').html('This field is required');
            return false;
        }
