...
<div class="main">
                ...
                <span>$ <?php echo $subName->price; ?></span>
     ...
     <!--	<li><img src="<?php echo base_url();?>images/tick.png" /> <p>Contrary to popular belief, Lorem Ipsum is not simply random text. </p></li>
       ...
       -->
                ...
                <h2 style="color:#da0606; margin-left:180px;">Free for <?php echo $subName->valid_date; ?></h2>
