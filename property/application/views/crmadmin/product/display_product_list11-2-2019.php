            ...
            <div class="widget_wrap">
                <div class="widget_top">
                    ...
                    <div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
                        ...
                        <?php } if ($allPrevCrm == '1' || in_array('2', $rental)) {
                            ?>
                            <!--<div class="btn_30_light" style="height: 29px;">
                                ...
                                <?php if ($allPrevCrm == '1' || in_array('0', $rental)) { ?>
                                    ...
                                    <ul class="doc_list1">
                                        ...
                                        <?php if ($row->sales_sdira == '' && $row->sales_fs == '') { ?>
                                            ...
                                            <li class="<?php
                                            if ($row->loi_status == 'processing')
                                                echo 'doc_yellow';
                                            else if ($row->loi_status == 'complete')
                                                echo 'doc_green';
                                            else
                                                echo 'doc_red';
                                            ?>"><a href="javascript:void(0);" onclick="popupCall('<?php echo $row->id . '/loi/' . $condition; ?>')" class="loi_popup ">LOI</a></li>

                                            <?php if ($row->sales_sl != '' || $row->sales_sl_fs != '' || $row->sales_cf != '' || $row->sales_cash || $row->sales_sdira != '') { ?>

                                                <li class="<?php
                                                if ($row->articles_status == 'processing')
                                                    echo 'doc_yellow';
                                                else if ($row->articles_status == 'complete')
                                                    echo 'doc_green';
                                                else
                                                    echo 'doc_red';
                                                ?>"><a href="javascript:void(0);" onclick="popupCall('<?php echo $row->id . '/articles/' . $condition; ?>')" class="ein_popup"><?php /* if($row->sales_sdira != '') echo 'Custodian Doc'; else */ echo 'Articles / EIN'; ?></a></li>

                                            <?php } ?>

                                            <li class="<?php
                                            if ($row->pa_status == 'processing')
                                                echo 'doc_yellow';
                                            else if ($row->pa_status == 'complete')
                                                echo 'doc_green';
                                            else
                                                echo 'doc_red';
                                            ?>"><a href="javascript:void(0);" onclick="popupCall('<?php echo $row->id . '/pa/' . $condition; ?>')" class="pa_popup">PA</a></li>
                                            ...
                                            <?php } if ($row->sales_fs != '' || $row->sales_cf != '' || $row->sales_sl_fs != '') { //$row->sales_sl != '' ?> 
                                                ...
                                                if ($row->loan_status == 'processing')
                                                    echo 'doc_yellow';
                                                else if ($row->loan_status == 'complete')
                                                    echo 'doc_green';
                                                else
                                                    echo 'doc_red';
                                                ?>"><a href="javascript:void(0);" onclick="popupCall('<?php echo $row->id . '/loan/' . $condition; ?>')" class="loan_popup">Loan Docs</a></li>
                                            ...
                                            <?php } if ($row->sales_sl != '' || $row->sales_sl_fs != '' || $row->sales_fs != '' || $row->sales_sdira != '') { ?> 
                                                <li class="<?php
                                                if ($row->doi_status == 'processing')
                                                    echo 'doc_yellow';
                                                else if ($row->doi_status == 'complete')
                                                    echo 'doc_green';
                                                else
                                                    echo 'doc_red';
                                                ?>"><a href="javascript:void(0);" onclick="popupCall('<?php echo $row->id . '/doi/' . $condition; ?>')" class="doi_popup" <?php if ($row->sales_fs != '' || $row->sales_sl_fs != '') echo 'style="width:85px;"'; ?>>DOI<?php if ($row->sales_fs != '' || $row->sales_sl_fs != '') echo ' / Reoccuring Bill Pay'; ?></a></li>
                                            ...
                                            if ($row->insurance_status == 'processing')
                                                echo 'doc_yellow';
                                            else if ($row->insurance_status == 'complete')
                                                echo 'doc_green';
                                            else
                                                echo 'doc_red';
                                            ?>"><a href="javascript:void(0);" onclick="popupCall('<?php echo $row->id . '/insurance/' . $condition; ?>')" class="insurance_popup">Insurance</a></li>

                                            <li class="<?php
                                            if ($row->closed_status == 'processing')
                                                echo 'doc_yellow';
                                            else if ($row->closed_status == 'complete')
                                                echo 'doc_green';
                                            else
                                                echo 'doc_red';
                                            ?>"><a href="javascript:void(0);" onclick="popupCall('<?php echo $row->id . '/closed/' . $condition; ?>')" class="closed_popup">Closing Docs</a></li>

                                            <li class="<?php
                                            if ($row->funded_status == 'processing')
                                                echo 'doc_yellow';
                                            else if ($row->funded_status == 'complete')
                                                echo 'doc_green';
                                            else
                                                echo 'doc_red';
                                            ?>"><a href="javascript:void(0);" onclick="popupCall('<?php echo $row->id . '/funded/' . $condition; ?>')" class="fund_popup">Funded</a></li>

                                            <li class="<?php
                                            if ($row->hand_off_status == 'processing')
                                                echo 'doc_yellow';
                                            else if ($row->hand_off_status == 'complete')
                                                echo 'doc_green';
                                            else
                                                echo 'doc_red';
                                            ?>"><a href="javascript:void(0);" onclick="popupCall('<?php echo $row->id . '/hand_off/' . $condition; ?>')" class="pmhand_popup">PM Hand Off</a></li>
                                            ...
                                            <li class="<?php
                                            if ($row->invoice_status == 'processing')
                                                echo 'doc_yellow';
                                            else if ($row->invoice_status == 'complete')
                                                echo 'doc_green';
                                            else
                                                echo 'doc_red';
                                            ?>"><a href="javascript:void(0);" onclick="popupCall('<?php echo $row->id . '/invoice/' . $condition; ?>')" class="invoice_popup">Invoice</a></li>
                                            ...
                                            <?php if ($this->uri->segment(4) != 'completed' && $this->uri->segment(4) != 'cancelled' && $this->uri->segment(4) != 'swapped' && $this->session->userdata('ror_crm_session_admin_type') == '') { ?>
                                                ...
                                                if ($this->session->userdata('ror_crm_session_admin_type') == '') {
                                                    ?>
                                                    <li class="<?php
                                                    if ($row->ror_iv_status == 'processing')
                                                        echo 'doc_yellow';
                                                    else if ($row->ror_iv_status == 'complete')
                                                        echo 'doc_green';
                                                    else
                                                        echo 'doc_red';
                                                    ?>"><a href="javascript:void(0);" onclick="popupCall('<?php echo $row->id . '/ror_iv/' . $condition; ?>')" class="loi_popup">ROR Invoice</a></li>
                                                    <li class="<?php
                                                    if ($row->gen_iv_status == 'processing')
                                                        echo 'doc_yellow';
                                                    else if ($row->gen_iv_status == 'complete')
                                                        echo 'doc_green';
                                                    else
                                                        echo 'doc_red';
                                                    ?>"><a href="javascript:void(0);" onclick="popupCall('<?php echo $row->id . '/gen_iv/' . $condition; ?>')" class="loi_popup">Lead Gen Invoice</a></li>
                                                        <?php
                                                    }
                                                }
                                                ?>
                                        ...
                                        <?php } else if ($row->sales_fs != '') { ?>
                                            ...
                                            <?php if ($row->sales_sl != '' || $row->sales_sl_fs != '' || $row->sales_fs != '' || $row->sales_sdira != '') { ?> 
                                                ...
                                                if ($row->doi_status == 'processing')
                                                    ...
                                                    echo 'doc_red';
                                                ?>"><a href="javascript:void(0);" onclick="popupCall('<?php echo $row->id . '/doi/' . $condition; ?>')" class="doi_popup" <?php if ($row->sales_fs != '') echo 'style="width:85px;"'; ?>>DOI<?php if ($row->sales_fs != '') echo ' / Reoccuring Bill Pay'; ?></a></li>
