...
?>
				...
				<table class="popup_table" align="center" border="0" bordercolor="#333" cellpadding="1" cellspacing="1" width="50%" style="float:left; margin-top:20px;">
                 ...
                 <!--  <tr>
                    ...
                    <tr>
                        ...
                        <td class="tab_mid">:</td>
                        <td class="tab_txt"><input type="text" name="phone_no1" value="<?php if($details ->phone_no1 != 0)echo $details->phone_no1; else echo ''; ?>" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <?php foreach($resCode->result() as $code){ ?>
							<option value=<?php echo '"'.$code->attribute_name.'"'; if($details->res_code == $code->attribute_name){ echo 'selected="selected"';} echo '>'.$code->attribute_name;?></option>
							<?php }?>
                        </select>
                       </td>
                    </tr>
             ...
             <div class="popup_field" style="margin:5px 0 0 10px; width:95%">
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
						...
						if($row->general != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->general.' - <b>'.$row->admin_name.'</b> </span> ';}  } ?>
                        </div>
                    </div>
                     <div class="clear"></div>    
  ...
  <?php } if ($display == 'loi'){?>
  	...
  	<div id='inline_loi' style='background:#fff;' class="pop_up_style">
  		...
  		<div class="popup_page">  
            ...
            <div class="clear"></div>
            <?php foreach($popup_img->result() as $imgs){
				if($imgs->loi != '') {
               ...
               <div class="popup_field">
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
                    	<div class="popup_txt_1" style="margin:0 0 0 10px; height:120px; width:95%;" id="showGeneral">
                        <?php foreach($admin_notes->result() as $row){ 
						if($row->loi != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->loi.' - <b>'.$row->admin_name.'</b> </span> ';}  } ?>
                        </div>
                    </div>
                    ...
                    <div class="popup_bottom_right" style="width:70%;">
                        ...
                        <input type="hidden" value="<?php echo $details->id;?>" id="rsd_id_loi" />
                         ...
                         <input type="submit" value="Save & Close" <?php if($details->sales_sl != '' || $details->sales_sl_fs != '' || $details->sales_fs != '' || $details->sales_sdira != '') echo 'onclick="loi_save()"'; if($details->sales_cash != '' || $details->sales_cf != '') echo 'onclick="cash_loi_save()"'; ?> class="popup_btn" style=" margin: 0 0 0 116px;" />
    ...
    width: 82px;" />
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
                    	<div class="popup_txt_1" style="margin:0 0 0 10px; height:120px; width:95%;" id="showGeneral">
                        <?php foreach($admin_notes->result() as $row){ 
						 if($row->articles != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->articles.' - <b>'.$row->admin_name.'</b> </span> ';}  } ?>
                        </div>
                    </div>
                     <div class="clear"></div>
    ...
    width: 82px;"  />
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
                    	<div class="popup_txt_1" style="margin:0 0 0 10px; height:120px; width:95%;" id="showGeneral">
                        <?php foreach($admin_notes->result() as $row){ 
						 	if($row->pa != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->pa.' - <b>'.$row->admin_name.'</b> </span> ';}  } ?>
                        </div>
                    </div>
                    <div class="clear"></div>
    ...
    width: 82px;" />
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
                    	<div class="popup_txt_1" style="margin:0 0 0 10px; height:120px; width:95%;" id="showGeneral">
                        <?php foreach($admin_notes->result() as $row){  
						if($row->llc != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->llc.' - <b>'.$row->admin_name.'</b> </span> ';}  } ?>
                        </div>
                    </div>
                    <div class="clear"></div>
                    <div class="popup_bottom_right">
  ...
  <?php } if ($display == 'loan'){?>
  	...
  	<div id='inline_loan' style='background:#fff;' class="pop_up_style">
  		...
  		<div class="popup_page">  
  			<div class="popup_header">Appraisal - <span><?php echo stripslashes($details->prop_address);?></span></div>   
            <span class="popup_sub_txt">Choose Files to Upload</span>
            <div class="popup_top_right">
    ...
    width: 82px;"/>
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
                    	<div class="popup_txt_1" style="margin:0 0 0 10px; height:120px; width:95%;" id="showGeneral">
                        <?php foreach($admin_notes->result() as $row){ 
						 if($row->loan != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->loan.' - <b>'.$row->admin_name.'</b> </span> ';}  } ?>
                        </div>
                    </div>
                    <div class="clear"></div>
    ...
    width: 82px;" />
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
                    	<div class="popup_txt_1" style="margin:0 0 0 10px; height:120px; width:95%;" id="showGeneral">
                        <?php foreach($admin_notes->result() as $row){ 
						 if($row->fedex != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->fedex.' - <b>'.$row->admin_name.'</b> </span> ';}  } ?>
                        </div>
                    </div>
                    <div class="clear"></div>
                    <div class="popup_bottom_right">
    ...
    width: 82px;"/>
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
                    	<div class="popup_txt_1" style="margin:0 0 0 10px; height:120px; width:95%;" id="showGeneral">
                        <?php foreach($admin_notes->result() as $row){ 
						 if($row->doi != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->doi.' - <b>'.$row->admin_name.'</b> </span> ';}  } ?>
                        </div>
                    </div>
                    <div class="clear"></div>
    ...
    width: 82px;"/>
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
                    	<div class="popup_txt_1" style="margin:0 0 0 10px; height:120px; width:95%;" id="showGeneral">
                        <?php foreach($admin_notes->result() as $row){  
						if($row->insurance != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->insurance.' - <b>'.$row->admin_name.'</b> </span> ';}  } ?>
                        </div>
                    </div>
                    <div class="clear"></div>
    ...
    width: 82px;"  />
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
                    	<div class="popup_txt_1" style="margin:0 0 0 10px; height:120px; width:95%;" id="showGeneral">
                        <?php foreach($admin_notes->result() as $row){  
						if($row->funded != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->funded.' - <b>'.$row->admin_name.'</b> </span> ';}  } ?>
                        </div>
                    </div>
                    <div class="clear"></div>
                    <div class="popup_bottom_right" style="width:75%; margin:5px 0 0 0px;">
    ...
    width: 82px;"/>
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
                    	<div class="popup_txt_1" style="margin:0 0 0 10px; height:120px; width:95%;" id="showGeneral">
                        <?php foreach($admin_notes->result() as $row){ 
                        	 if($row->closed != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->closed.' - <b>'.$row->admin_name.'</b> </span> ';}  } ?>
                        </div>
                    </div>
                    <div class="clear"></div>
                    <div class="popup_bottom_right" style="width:75%; margin:5px 0 0 0px">
    ...
    width: 82px;" />
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
                    	<div class="popup_txt_1" style="margin:0 0 0 10px; height:120px; width:95%;" id="showGeneral">
                        <?php foreach($admin_notes->result() as $row){ 
                        	 if($row->hand_off != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->hand_off.' - <b>'.$row->admin_name.'</b> </span> ';} 
  ...
  <?php } if ($display == 'master'){?>
  	...
  	<div id='inline_master' style='background:#fff;' class="pop_up_style">
  		...
  		<div class="popup_page">  
            ...
            <?php foreach($admin_notes->result() as $row){ ?>
               <?php if($row->ror_iv != '' && $this->session->userdata('ror_crm_session_admin_type') == '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->ror_iv.' - <b>'.$row->admin_name.'</b> </span> ';} 
					 if($row->gen_iv != '' && $this->session->userdata('ror_crm_session_admin_type') == '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->gen_iv.' - <b>'.$row->admin_name.'</b> </span> ';} 
					 if($row->master != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->master.' - <b>'.$row->admin_name.'</b> </span> ';} 
					 if($row->hand_off != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->hand_off.' - <b>'.$row->admin_name.'</b> </span> ';} 
					 if($row->closed != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->closed.' - <b>'.$row->admin_name.'</b> </span> ';} 
					 if($row->funded != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->funded.' - <b>'.$row->admin_name.'</b> </span> ';} 
					 if($row->insurance != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->insurance.' - <b>'.$row->admin_name.'</b> </span> ';} 
    ...
    width: 82px;" />
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
                    	<div class="popup_txt_1" style="margin:0 0 0 10px; height:120px; width:95%;" id="showGeneral">
                        <?php foreach($admin_notes->result() as $row){ 
						if($row->invoice != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->invoice.' - <b>'.$row->admin_name.'</b> </span> ';}  } ?>
                        </div>
                    </div>
                    <div class="clear"></div>
                    <div class="popup_bottom_right" style="width:75%; margin:8px 0 0 0px;">
              ...
              <div class="generate-invoices"> <a onclick="return invoiceValidation()" href="<?php echo base_url().'crmadmin/product/downloadPDF/'.$admin_status->row()->reserved_id;?>" class="popup_btn">Generate Invoice</a></div>      
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
                        ...
                        <?php foreach($admin_notes->result() as $row){ 
						if($row->ror_iv != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->ror_iv.' - <b>'.$row->admin_name.'</b> </span> ';}  } ?>
                        </div>
                    </div>
          ...
          <div style="float:left; width:100%; min-height:100px"></div>
                ...
                <div class="popup_bottom">
                	<div class="popup_bottom_left">
                    	<div class="popup_txt_1" style="margin:0 0 0 0px; height:120px; width:95%!important;" id="showGeneral">
                        <?php foreach($admin_notes->result() as $row){ 
						if($row->gen_iv != '') { echo '<span><p style="color:#F00; float:left; margin-right:3px;">'. $row->added.' - </p>' .$row->gen_iv.' - <b>'.$row->admin_name.'</b> </span> ';}  } ?>
                        </div>
                    </div>
            ...
            <div class="popup_middle">   
				<?php if($alertLists->num_rows()>0){ ?>
					<ul class="alert-ulist">
						...
						<?php $i=0; foreach($alertLists->result() as $alert){ $i++; ?>
						<li class="alert-list">
