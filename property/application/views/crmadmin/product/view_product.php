...
//						}
                ...
                <div class="form_grid_12">
                  ...
                  <div class="form_input">
                   <?php 
					  ...
					  ?>
										<li style="float: left;">
										<div class="widget_thumb" style="margin-left: 2%;width:150px;height:150px;">
										 	<img width="150px" height="150px" src="<?php echo base_url();?>images/product/thumb/<?php echo $ProImag->product_image; ?>" />
										</div>
              ...
              <li>
                  <div class="form_grid_12">
                    <div class="form_input"><a href="crmadmin/product/display_product_list" class="tipLeft" title="Go to property list"><span class="badge_style b_done">Back</span></a>
                      </div>
                      </div>
                      </li>
                      </ul>                      
