              ...
              <li>
               ...
               <li>
                <div class="form_grid_12">
                  ...
                  <div class="form_input" id="listCountryCnt">
                  <input type="text" name="city" id="city"  onblur="return geocode();" tabindex="8" class="required large tipTop" title="Please enter the city name" />
...
{ 
		...
		{
				type: 'POST',
				url: baseURL+'crmadmin/product/get_sub_type_details',
				data:{'typeId':Id},
