...
<div id="content">
		<div class="grid_container">
			<?php 
				...
				echo form_open('crmadmin/productattribute/change_attribute_status_global',$attributes) 
			?>
			<div class="grid_12">
					...
					<div class="widget_content">
						...
						<tr>
							...
							if ($allPrevCrm == '1' || in_array('2', $propertytype)){
								...
								if ($mode == '0'){
							?>
								<a title="Click to inactive" class="tip_top" href="javascript:confirm_status('crmadmin/productattribute/change_attribute_status/<?php echo $mode;?>/<?php echo $row->id;?>');"><span class="badge_style b_done"><?php echo $row->status;?></span></a>
							<?php
								}else {	
							?>
								<a title="Click to active" class="tip_top" href="javascript:confirm_status('crmadmin/productattribute/change_attribute_status/<?php echo $mode;?>/<?php echo $row->id;?>')"><span class="badge_style"><?php echo $row->status;?></span></a>
							<?php 
								}
							}else {
							?>
							...
							<td class="center">
							<?php if ($allPrevCrm == '1' || in_array('2', $propertytype)){?>
								<span><a class="action-icons c-edit" href="crmadmin/productattribute/edit_attribute_form/<?php echo $row->id;?>" title="Edit">Edit</a></span>
							<?php }?>
							...
							<?php if ($allPrevCrm == '1' || in_array('3', $propertytype)){?>	
								<span><a class="action-icons c-delete" href="javascript:confirm_delete('crmadmin/productattribute/delete_attribute/<?php echo $row->id;?>')" title="Delete">Delete</a></span>
							<?php }?>
							</td>
						</tr>
						<?php 
