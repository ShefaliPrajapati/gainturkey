			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Edit Property Type</h6>
					</div>
					<div class="widget_content">
					<?php 
						$attributes = array('class' => 'form_container left_label', 'id' => 'edituser_form', 'enctype' => 'multipart/form-data');
						echo form_open_multipart('crmadmin/productattribute/EditAttribute',$attributes) 
					?>
                ...
                <ul>
							...
							<div class="form_input">
								<input name="attr_name" id="attr_name" type="text" tabindex="1" class="required large tipTop" title="Please enter the property name" value="<?php echo $attribute_details->row()->attr_name;?>"/>
							</div>
							</div>
							</li>
