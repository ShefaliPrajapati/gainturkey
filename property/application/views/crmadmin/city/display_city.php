...
<div id="content">
		<div class="grid_container">
			<?php 
				...
				echo form_open('crmadmin/city/change_city_status_global',$attributes) 
			?>
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<?php if ($allPrevCrm == '1' || in_array('2', $city)){?>
						...
						if ($allPrevCrm == '1' || in_array('3', $city)){
						?>
							<div class="btn_30_light" style="height: 29px;">
					...
					<div class="widget_content">
						...
						<tr>
							...
							<td class="center">
							<?php 
							if ($allPrevCrm == '1' || in_array('2', $city)){
								$mode = ($row->status == 'Active')?'0':'1';
								if ($mode == '0'){
							?>
								<a title="Click to inactive" class="tip_top" href="javascript:confirm_status('crmadmin/city/change_city_status/<?php echo $mode;?>/<?php echo $row->id;?>');"><span class="badge_style b_done"><?php echo $row->status;?></span></a>
							<?php
								}else {	
							?>
								<a title="Click to active" class="tip_top" href="javascript:confirm_status('crmadmin/city/change_city_status/<?php echo $mode;?>/<?php echo $row->id;?>')"><span class="badge_style"><?php echo $row->status;?></span></a>
							<?php 
								}
							}else {
							?>
							...
							<td class="center">
							<?php if ($allPrevCrm == '1' || in_array('2', $city)){?>
								<span><a class="action-icons c-edit" href="crmadmin/city/edit_city_form/<?php echo $row->id;?>" title="Edit">Edit</a></span>
							<?php }?>
								<span><a class="action-icons c-suspend" href="crmadmin/city/view_city/<?php echo $row->id;?>" title="View">View</a></span>
							<?php if ($allPrevCrm == '1' || in_array('3', $city)){
							?>
                            	
								<span><a class="action-icons c-delete" href="javascript:confirm_delete('crmadmin/city/delete_city/<?php echo $row->id;?>')" title="Delete">Delete</a></span>
							<?php  }?>
							</td>
						</tr>
						<?php 
