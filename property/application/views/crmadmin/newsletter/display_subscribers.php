...
<div id="content">
  <div class="grid_container">
    <?php 
				...
				echo form_open('crmadmin/newsletter/change_newsletter_status_global',$attributes) 
			?>
    <div class="grid_12">
      <div class="widget_wrap">
        <div class="widget_top"> <span class="h_icon blocks_images"></span>
          ...
          <div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
            <?php if ($allPrevCrm == '1' || in_array('2', $newsletter)){?>
		  ...
		  foreach ($NewsList->result() as $SendNews){ if($SendNews->id >11){?>
            ...
            <?php 
						...
						if ($allPrevCrm == '1' || in_array('3', $newsletter)){
						?>
          ...
          <table class="display" id="subscriber_tbl">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="center"><?php 
							if ($allPrevCrm == '1' || in_array('2', $newsletter)){
								$mode = ($row->status == 'Active')?'0':'1';
								if ($mode == '0'){
							?>
                  <a title="Click to inactive" class="tip_top" href="javascript:confirm_status('crmadmin/newsletter/change_subscribers_status/<?php echo $mode;?>/<?php echo $row->id;?>');"><span class="badge_style b_done"><?php echo $row->status;?></span></a>
                  <?php
								}else {	
							?>
                  <a title="Click to active" class="tip_top" href="javascript:confirm_status('crmadmin/newsletter/change_subscribers_status/<?php echo $mode;?>/<?php echo $row->id;?>')"><span class="badge_style"><?php echo $row->status;?></span></a>
                  <?php 
								}
							}else {
							?>
                ...
                <td class="center"><!--<?php if ($allPrevCrm == '1' || in_array('2', $newsletter)){?>
								<span><a class="action-icons c-edit" href="crmadmin/users/edit_user_form/<?php echo $row->id;?>" title="Edit">Edit</a></span>
							<?php }?>
								<span><a class="action-icons c-suspend" href="crmadmin/users/view_user/<?php echo $row->id;?>" title="View">View</a></span>-->
                  <?php if ($allPrevCrm == '1' || in_array('3', $newsletter)){?>
                  <span><a class="action-icons c-delete" href="javascript:confirm_delete('crmadmin/newsletter/delete_subscribers/<?php echo $row->id;?>')" title="Delete">Delete</a></span>
                  <?php }?>
                </td>
              </tr>
              <?php 
