...
<div id="login_page">
	<div class="login_container">
		<div class="login_header blue_lgel">
			<ul class="login_branding">
				...
				<div class="logo_small" >
					<img src="images/logo/<?php echo $logo;?>" width="250px" alt="<?php echo $siteTitle;?>" title="<?php echo $siteTitle;?>" style="margin-top:0px;">
				</div>
				<span></span>
				</li>
		...
		<?php echo form_open('crmadmin/adminlogin/admin_forgot_password') ?>
			...
			<ul class="login_opt_link tipBotR">
				<li><a href="admin_ror" class="tipLeft" title="Go to login form">Back to login</a></li>
			</ul>
		</form>
	</div>
</div>
