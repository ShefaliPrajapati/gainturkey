...
(function($) {
	$.fn.jRating = function(op) {
		var defaults = {
			...
			bigStarsPath : 'js/jquerys/icons/img-full-star-grey.png', // path of the icon stars.png
			smallStarsPath : 'js/jquerys/icons/small.png', // path of the icon small.png
			...
			rateInfosY : 6, // relative position in Y axis of the info box when mouseover
		...
		return this.each(function() {
			...
			$(this).bind({
				...
				click : function(e){
					...
					average.width(newWidth);
						...
						$.post(path+"imcuteAjax.php", { 'ratetsend[]': [rate, pet_id] });
			...
			function getNote(relativeX) {
				var noteBrut = parseInt((relativeX*110/widthRatingContainer)*opts.rateMax/100);
