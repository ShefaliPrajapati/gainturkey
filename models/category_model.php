...
class Category_model extends My_Model
{
    ...
    public function view_category_list_main($CatRow, $val, $arr_val)
    {
		...
		<div class="posView">
			<input title="Category Position" class="tipTop" type="text" name="cat_position" value="' . $CatRow->cat_position . '.$CatRow->id.'\')">Update</a>
    ...
    public function view_category_details()
    {
        ...
        if ($this->session->userdata('ror_crm_session_admin_name') == $this->config->item('admin_name')) {
            $Admpriv = '1';
            $newSubAdmin = $this->session->userdata('ror_crm_session_admin_privileges');
        }
