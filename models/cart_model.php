...
class Cart_model extends My_Model
{
    ...
    public function mani_cart_view($userid = '')
    {
       ...
       ';
			...
			<td rowspan="2" class="thumnail"><a href="things/' . $CartRow->prdid . '/' . $CartRow->seourl . '"><img src="' . $newImgpath . '" alt="' . $CartRow->product_name . '"></a><a href="javascript:void(0);" onclick="delete_cart(' . $CartRow->id . ',' . $s . ')" class="remove_item">Remove</a></td>
			...
			<td class="quantity"><select name="quantity' . $s . '" id="quantity' . $s . '" class="select-round" style="width:60px;" data-mqty="' . $CartRow->mqty . '" onchange="update_cart(' . $CartRow->id . ',' . $s . ')">';
		...
		<tr>
		  ...
		  <div class="cart-payment" id="merchant-cart-payment">
			...
			<dl class="cart-coupon">
				...
				<input type="button" class="btn-blue-apply apply-coupon" onclick="checkCode();" value="Apply" style="cursor:pointer;" /></dd>
