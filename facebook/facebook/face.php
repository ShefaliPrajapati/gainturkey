...
include_once '../main.php';
        ...
        //print_r($user);die;
            ...
            if ($SelRow>0) {
                ...
                $insQuery="INSERT INTO ".USER." (emailAddress,fname,lname,status,dateAdded,verify,fb_id,refer_id,login_type) VALUES('".$email."','".$firstName."','".$lastName."','Active','".date('Y-m-d')."','".$verified."','".$fb_id."','".$random."','User') ";
