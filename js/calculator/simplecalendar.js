	...
	*****************************************************************************************************
	...
	This script had changed by AGUK. If element name is element of array, as in PHP,
	then script not working. Changed next lines:
	from:
    var tmp = eval('document.' + this.target);
	to
    var arr = document.getElementsByName(this.target); 
    if (arr.length > 1 || arr.length == 0)
         { 
           var tmp = arr[0];	
 		   ... 
	My will calendar not working if in page present much elements with equal names.
	*****************************************************************************************************
	*/
	...
	if (browser.dom || browser.ie4){
		...
		document.writeln('}');
		document.writeln('</style>')
		document.write('<div id="containerCL"');
	...
	function Calendar(){
	  ...
	  if (browser.dom || browser.ie4){
		var tmpLayer = browser.dom?document.getElementById('containerCL'):document.all.containerCL;
	  }
	...
	Calendar.prototype.clickDay = function(day){
        /// AGUK. fixed if element name is array
	    // var tmp = eval('document.' + this.target);
	...
	function handleDocumentClick(e){
	  // -- start changed 20071115	 
	  if (g_Calendar == null)	
	     return;
	  // -- end changed 20071115	 
