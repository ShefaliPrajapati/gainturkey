...
<input type="hidden" name="CompVals" id="CompVals" value="0" />
<div id="content">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="form_grid_12">
                                    ...
                                    <div class="form_input">
                                        <input id="property_id" type="text" tabindex="1" class="required large tipTop" name="property_id" title="Please enter the property id" onchange="javascript:prpIdCheck()" onblur="javascript:prpIdCheck()" />
                                ...
                                <div class="form_grid_12">
                                    ...
                                    <div class="form_input">
                                        <div class="publish_unpublish">
                                            ...
                                            <input type="radio" tabindex="11" name="display" id="display" class="publish_unpublish" value="sub" /> piprentals.com
											<input type="radio" tabindex="11" name="display" id="display" class="publish_unpublish" value="cfr" /> cashflowready.com
                        ...
                        <ul id="AttributeView">
                            ...
                            <li>
                                <div class="form_grid_12">
                                    ...
                                    <div class="form_input">
                                        <input type="text" name="monthly_rent" id="monthly_rent" tabindex="9" class="required large tipTop" onkeypress="calcAnnualPay();" onkeydown="calcAnnualPay();"   onkeyup="calcAnnualPay();" onchange="calcAnnualPay()" title="Please enter the monthly rental" onblur="MonthlyRent()" />
                            ...
                            <li>
                                <div class="form_grid_12">
                                    ...
                                    <div class="form_input">
                                        <input type="text" name="annual_Rent" onchange="netValue();" id="annual_Rent" tabindex="9" class="required large tipTop"  readonly title="Please enter the annual rental" />
                            ...
                            <li>
                                <div class="form_grid_12">
                                    ...
                                    <div class="form_input">
                                        <input type="text" name="hazard_ins"  onkeypress="netValue();"  onkeydown="netValue();" onkeyup="calcAnnualPay();" onchange="netValue();"  id="hazard_ins" tabindex="9" class="required large tipTop" title="Please enter the estimated annual hazard insurance" />
                            ...
                            <li>
                                <div class="form_grid_12">
                                    ...
                                    <div class="form_input">
                                        <input type="text" name="property_tax"  onkeypress="netValue();"  onkeydown="netValue();" onkeyup="calcAnnualPay();"  onchange="netValue();"  id="property_tax" tabindex="9" class="required large tipTop" title="Please enter the estimated property tax" />
                            ...
                            <li>
                                <div class="form_grid_12">
                                    ...
                                    <div class="form_input">
                                        <input type="text" name="management_expenses"  onkeypress="netValue();"  onkeydown="netValue();" onkeyup="calcAnnualPay();" onchange="netValue();"  id="management_expenses" tabindex="9" class="required large tipTop" title="Please enter the property management expenses" onchange="get" />
                            ...
                            <li>
                                <div class="form_grid_12">
                                    ...
                                    <div class="form_input">
                                        <input type="text" name="utilities" id="utilities"  onkeypress="netValue();"  onkeydown="netValue();" onkeyup="calcAnnualPay();" onchange="netValue();"  tabindex="9" class="required large tipTop" title="Please enter the utilities" />
                            ...
                            <li>
                                <div class="form_grid_12">
                                    ...
                                    <div class="form_input">
                                        <input type="text" name="net_income"  id="net_income" readonly tabindex="9" class="required large tipTop" title="Please enter the estimated net income" />
                                ...
                                <div class="form_grid_12">
                                    ...
                                    <div class="form_input" id="listCountryCnt">
                                        <select name="state" id="state" onblur="return geocode();" title="Please enter the post code">
                                            <?php
                                            foreach ($stateDetails->result() as $state) {
                                        ...
                                        <div class="form_input">
                                            ...
                                            <fieldset class="gllpLatlonPicker">
                                              <!-- <input type="text" class="gllpSearchField" value="">-->
                                                ...
                                                <br/>
                                                <input type="hidden" name="latitude" id="latitude" class="gllpLatitude" />
                                                <input type="hidden" name="longitude" id="longitude" class="gllpLongitude" />
                        ...
                        <ul>
                            ...
                            <li style="border-bottom:none; background:none;">
                                <div class="form_grid_12">
                                    ...
                                    <div id="addRemoveResetProd"  class="product-add-remove" style="float:right;">
                                        <span id="compadd" style="cursor: pointer;" class="icon32 icon-add" title="Add Image"><div class="btn_30_light">
                                                <a href="javascript:void(0);"><span class="icon add_co"></span><span class="btn_link">Add</span></a>
                                            </div></span>
                            ...
                            <li style=" border-top:1px solid #CCC;">
                                <div class="form_grid_12">
                                    <div class="form_input">
                                        <input type="button" class="btn_small btn_blue prvTab" tabindex="9" value="Prev"/>
                                        <input type="button" id="addressInfo" class="btn_small btn_blue nxtTab" tabindex="7" value="Next"/>
                                    </div>
                                </div>
                            </li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="form_grid_12">
                                    <div class="form_input">
                                        <input type="button" class="btn_small btn_blue prvTab" tabindex="9" value="Prev"/>
                                        <input type="submit" class="btn_small btn_blue" tabindex="9" value="Save" name="submit_button"/>
    ...
    $(function () {
        $("#addproperty_form").submit(function () {
            ...
            if (jQuery.trim($("#property_id").val()) == '') {
                ...
                $("#tab_common7").addClass("active_tab");
