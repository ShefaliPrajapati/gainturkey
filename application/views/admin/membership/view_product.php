					...
					?>
                     ...
                     <div id="tab1">
						<ul>
                            ...
                            <li>
								<div class="form_grid_12">
								<label class="field_title" for="description"><?php  echo $product_details->row()->option_type;?> For</label>
								<div class="form_input">
								<?php 
                      ...
                      <div id="tab3">
									<ul>
										...
										<div class="widget_thumb" style="margin-left: 2%;width:100px;height:100px;">
										 	<img width="100px" height="100px" src="<?php echo base_url();?>images/<?php echo $img;?>" />
										</div>
										</li>
										<?php 
												}
