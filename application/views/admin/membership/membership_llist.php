					...
					<div class="widget_content">
						...
						<tr>
							...
							<!--<td class="center">
								 ...
								 <img class="rollovereff" src="<?php echo base_url();?>images/fancyybox/<?php echo $row->image;?>" />
								</div>
							</td>-->
							<td class="center">
								<?php echo $row->price;?>
							...
							<td class="center">
							<span class="badge_style b_done"><?php if($row->approved == 'yes') echo "Active"; else echo "Inactive";?></span>
							</td>
							<td class="center">
