				...
				<div class="widget_wrap">
					...
					<div class="widget_content">
						<div class="stat_block">
							<h4><?php echo $sellerList->num_rows();?> renters registered in this site</h4>
							<table>
							<tbody>
							<tr>
								<td>
								...
								<td>
									<?php echo $sellerList->row()->full_name;?>
								</td>
							</tr>
							<!--<tr>
								<td>
						...
						?>
							<div class="user_block">
								<div class="info_block">
									...
									<ul class="list_info">
										<li><span>First Name: <i><?php echo $pendingRow->first_name;?></i></span></li>
