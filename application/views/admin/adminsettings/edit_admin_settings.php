          ...
          <div class="widget_content">
              ...
              <ul>
                <li>
                  <div class="form_grid_12">
                    <label class="field_title" for="admin_name">Admin User Name <span class="req">*</span></label>
                ...
                <li>
                 ...
                 <li>
                  <div class="form_grid_12">
                    <label class="field_title" for="site_contact_number">Site contact Number</label>
                    <div class="form_input">
                      <input name="site_contact_number" id="site_contact_number" type="text" value="<?php echo $admin_settings->row()->site_contact_number;?>" tabindex="2" class="large tipTop" title="Please enter the admin email address"/>
                    </div>
                  </div>
                </li>
                <li>
                ...
                <!-- <li>
                  <div class="form_grid_12">
                    <label class="field_title" for="logo_image"> PreigRentals Logo</label>
                    <div class="form_input">
                      <input name="pr_logo_image" id="pr_logo_image" type="file" tabindex="5" class="large tipTop" title="Please select the logo image"/>
                    </div>
                    <div class="form_input"><img src="<?php echo base_url();?>images/logo/<?php echo $admin_settings->row()->pr_logo_image;?>" width="100px"/></div>
                  </div>
                </li>
                <li>
                  <div class="form_grid_12">
                    <label class="field_title" for="fevicon_image"> PreigRentals Favicon</label>
                    <div class="form_input">
                      <input name="pr_fevicon_image" id="pr_fevicon_image" type="file" tabindex="6" class="large tipTop" title="Please select the favicon image"/>
                    </div>
                    <div class="form_input"><img src="<?php echo base_url();?>images/logo/<?php echo $admin_settings->row()->pr_fevicon_image;?>" width="50px"/></div>
                  </div>
                </li>-->
                <li>
                  <div class="form_grid_12">
                    <label class="field_title" for="booking_code">Property Booking Code</label>
                    <div class="form_input">
                      <input name="booking_code" id="booking_code" type="text" value="<?php echo htmlentities($admin_settings->row()->booking_code);?>" tabindex="7" class="large tipTop" title="Please enter the Property booking code"/>
                    </div>
                  </div>
                </li>
                <li>
				 ...
				 <li>
                  <div class="form_grid_12">
                    <label class="field_title" for="footer_content">Map Option</label>
                    <div class="form_input">
                      <input type="radio" name="map_option" id="map_option" value="1" class="tipTop" title="Please Choose the map option" <?php if($admin_settings->row()->map_option == 1){ echo 'checked="checked"';} ?> /> Map 1
					  
					  <input type="radio" name="map_option" id="map_option" value="2" class="tipTop" title="Please Choose the map option" <?php if($admin_settings->row()->map_option == 2){ echo 'checked="checked"';} ?>/>Map 2
            ...
            <div id="tab2">
              ...
              <div class="form_grid_12">
                ...
                <li>
                  <div class="form_grid_12">
                    <label class="field_title" for="twitter_link">Instagram Link</label>
                    <div class="form_input">
                      <input name="linkedin_link" id="linkedin_link" type="text" tabindex="11" value="<?php echo $admin_settings->row()->linkedin_link;?>" class="large tipTop" title="Please enter the site linkedin url"/>
                    </div>
                  </div>
                </li>
               ...
               <li>
                ...
                <li>
                  <div class="form_grid_12">
                    ...
                    <div class="form_input">
                      <textarea name="google_verification_code" class="input_grow tipTop" title="Copy google analytics code and paste here" cols="70" rows="10" tabindex="4"><?php echo $admin_settings->row()->google_verification_code;?></textarea>
                      <br />
                      <span>For Examples:
