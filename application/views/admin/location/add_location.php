					...
					?> 		
                    	<div id="tab1">
	 						<ul>
                                ...
                                <li>
								<div class="form_grid_12">
									<label class="field_title" for="thumb">Thumbnail image<span class="req">*</span></label>
									<div class="form_input">
                                    <input name="thumb" style=" width:295px" id="thumb" type="file" tabindex="1" class="required tipTop" title="Please enter the thumbnail"/>
									</div>
								</div>
								</li>
