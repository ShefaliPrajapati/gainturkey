                    	...
                    	<div id="tab1">
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <textarea name="currency_symbol" class="required tipTop" id="currency_symbol" rows="" cols=""><?php echo $location_details->row()->currency_symbol;?></textarea>
<!--                                     <input name="currency_symbol" style=" width:295px" id="currency_symbol" type="text" tabindex="1" value="<?php echo $location_details->row()->currency_symbol;?>" class="required tipTop" title="Please enter the currency symbol"/>
	 -->								</div>
                                ...
                                <li>
								<div class="form_grid_12">
									<label class="field_title" for="thumb">Thumbnail<span class="req">*</span></label>
									<div class="form_input">
