    ...
    <div id="photos_div" class="main_content" >
      ...
      <?php
		...
		if(count($imgArr)>0)
		{
			...
			{
				echo '<li><img src="'.base_url().'images/product/'.$img['product_image'].'" width="630" alt="'.$img['imgtitle'].'" /></li>';
			 }
		}
		else
		{
			echo '<li><img src="images/product/dummyProductImage.jpg" width="192" height="113" alt="" /></li>';
		}
	  ?>
	</ul>
    </div>
...
<div id="details" class="box">
                ...
                <ul class="photo_list">
                	...
                	<?php
						...
						if(count($imgArr)>0)
						{
							foreach ($imgArr as $img)
							{
								echo '<li><img src="'.base_url().'images/product/'.$img['product_image'].'" alt="'.$img['imgtitle'].'" width="483" /></li>';
							 }
						}
						else
						{
							echo '<li><img src="images/product/dummyProductImage.jpg" width="483" /></li>';
						}
					?>
                </ul>         
            </div>
    ...
    <div class="matte-media-box matte_owner"><img alt="Owner" src="images/users/<?php if($product->thumbnail=='')echo "owner_img.png"; else echo $product->thumbnail; ?>" width="180" height="180" title="Owner" />
      </div>
