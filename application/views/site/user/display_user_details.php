...
<div id="ShowPopupContent" style="display:none" >
			<div class="click_popup" style="background:#FFF; z-index:9999;" >
                ...
                <p>In order to provide you with that information in electronic form, your consent must be obtained and the consumer disclosures in this notice must be given to you. This may be the only time you will be able to access this notice, so you should print or save this notice and keep a copy for your records. If you have any questions about receiving documents in electronic form, please contact your agent or an attorney directly or contact us via web support at <a href="<?php echo base_url(); ?>contact" target="_blank">http://www.returnonrentals.com/contact</a>. Additionally, to use Return on Rentals E-Sign (the "Service") you must agree to be bound by the terms and conditions of use.</p>
