    ...
    <div class="grid_12">
      <div class="widget_wrap">
        <div class="widget_top"> <span class="h_icon list"></span>
          ...
          <div id="widget_tab">
            <ul>
              <li><a href="#tab1" class="active_tab tab_common" id="tab_common1">General Information</a></li>
              <li><a href="#tab2" class="tab_common" id="tab_common2">Images</a></li>
          ...
          <div id="tab1">
            <ul>
                ...
                <div class="form_grid_12">
                  <label class="field_title" for="bedroom">Headline<span class="req">*</span></label>
                  <div class="form_input">
                    <input id="headline" type="text" tabindex="1" class="required large tipTop" name="headline" title="Please enter the headline" value="<?php echo stripslashes($product_details->row()->headline); ?>" />
                      <span id="headline_warn" class="redfont" style="color:#F00;"></span>
                  </div>
                </div>
              </li> 
            -->
            ...
            <ul>
              ...
              <li>
                <div class="form_grid_12">
                  ...
                  <input style="float:left" type='file' name="product_image[]" multiple="multiple" id="product_image" onchange='Test1.UpdatePreview1(this)' class="large multi tipTop"   />
   				                  
                                  
                                  
                                  
                                  
                                 <div class="dragndrop">Click Here for drag and drop upload</div>
                  ...
                  <!--<input name="product_image[]" id="product_image" type="file" tabindex="7" class="large tipTop" title="Please select product image"/>
                    <input style="float:left;" class="small tipTop"  placeholder="Caption" name="imgtitle[]" type="text">
                	<input style="float:left;" class="small tipTop"  placeholder="Priority" name="imgPriority[]" type="text">--
                    <div id="addRemoveResetProd"  class="product-add-remove">
                       ...
                       <!--<span id="reset" class="icon32 icon-cross" title="Reset"><div class="btn_30_light">
