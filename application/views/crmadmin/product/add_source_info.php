        ...
        <div class="widget_top"> <span class="h_icon list"></span>
					...
					<div class="widget_content">
					 ...
					 <?php 
						...
						echo form_open_multipart('crmadmin/product/add_source_info',$attributes);
             ...
             <li>
              ...
              <li>
                <div class="form_grid_12">
                  ...
                  <div class="form_input">
                    <input name="s_email" id="s_email"  type="text" tabindex="1" class="large tipTop" title="Please enter sourcer email"/>
             ...
             <!-- <div id="tab2" class="tab_common_class">
              ...
              <li>
                <div class="form_grid_12">
                  ...
                  <div class="form_input">
                    <input name="m_email" id="m_email"  type="text" tabindex="1" class="large tipTop" title="Please enter manager email"/>
