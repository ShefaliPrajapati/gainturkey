                            ...
                            if ($productList->num_rows() > 0) {
                                ...
                                foreach ($productList->result() as $row) {
                                    ...
                                    if ($this->uri->segment(4) != 'completed' && $row->invoice_status != 'complete' || $this->uri->segment(4) == 'completed') {
                                        if ((isset($crmcodenames) && is_array($crmcodenames)) && in_array(0, $crmcodenames) || $allPrevCrm == '1') {
                                            $i++;
                                            ...
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <?php if ($row->adjustment != '') {
                                                        echo number_format($row->net_purchase_price, 0);
                                                    } else {
                                                        echo number_format($row->sales_price, 0);
                                                    } ?>
                                                </td>
                                                <td class="center">
                                ...
                                <?php if ($allPrevCrm == '1' || in_array('0', $rental)) {
                                    ...
                                    <ul class="doc_list1">
                                        ...
                                        if ($row->have_alert == 'Yes') {
                                            ...
                                            <li class="alarm <?php echo $alarmClass; ?>">
                                                <a href="javascript:void(0);"
                                                   onclick="popupCall('<?php echo $row->id . '/view-alert-list/' . $condition; ?>')"
                                                   class="alert_popup">
                                                    &nbsp;
                                                </a>
                                            </li>
                                        ...
                                        <?php if ($row->sales_sdira == '' && $row->sales_fs == '') {
                                            ...
                                            <li class="doc_grey"><a href="javascript:void(0);"
                                                                    onclick="popupCall('<?php echo $row->id . '/general/' . $condition; ?>')"
                                                                    class="general_popup">General</a></li>

                                            <li class="<?php if ($row->loi_status == 'processing') {
                                                echo 'doc_yellow';
                                            } elseif ($row->loi_status == 'complete') {
                                                echo 'doc_green';
                                            } else {
                                                echo 'doc_red';
                                            } ?>"><a href="javascript:void(0);"
                                                     onclick="popupCall('<?php echo $row->id . '/loi/' . $condition; ?>')"
                                                     class="loi_popup ">LOI</a></li>

                                            <?php if ($row->sales_sl != '' || $row->sales_sl_fs != '' || $row->sales_cf != '' || $row->sales_cash || $row->sales_sdira != '') {
                                                ?>

                                                <li class="<?php if ($row->articles_status == 'processing') {
                                                    echo 'doc_yellow';
                                                } elseif ($row->articles_status == 'complete') {
                                                    echo 'doc_green';
                                                } else {
                                                    echo 'doc_red';
                                                } ?>"><a href="javascript:void(0);"
                                                         onclick="popupCall('<?php echo $row->id . '/articles/' . $condition; ?>')"
                                                         class="ein_popup"><?php /*if($row->sales_sdira != '') echo 'Custodian Doc'; else*/
                                                        echo 'Articles / EIN'; ?></a></li>

                                                <?php
                                            } ?>

                                            <li class="<?php if ($row->pa_status == 'processing') {
                                                echo 'doc_yellow';
                                            } elseif ($row->pa_status == 'complete') {
                                                echo 'doc_green';
                                            } else {
                                                echo 'doc_red';
                                            } ?>"><a href="javascript:void(0);"
                                                     onclick="popupCall('<?php echo $row->id . '/pa/' . $condition; ?>')"
                                                     class="pa_popup">PA</a></li>

                                            <?php if ($row->sales_sl != '' || $row->sales_sl_fs != '') {
                                                ?>
                                                <li class="doc_grey"><a href="javascript:void(0);"
                                                                        onclick="popupCall('<?php echo $row->id . '/llc'; ?>')"
                                                                        class="llc_popup">LLC</a></li>

                                                <?php
                                            }
                                            if ($row->sales_fs != '' || $row->sales_cf != '' || $row->sales_sl_fs != '') { //$row->sales_sl != ''?>
                                                <li class="<?php if ($row->loan_status == 'processing') {
                                                    echo 'doc_yellow';
                                                } elseif ($row->loan_status == 'complete') {
                                                    echo 'doc_green';
                                                } else {
                                                    echo 'doc_red';
                                                } ?>"><a href="javascript:void(0);"
                                                         onclick="popupCall('<?php echo $row->id . '/loan/' . $condition; ?>')"
                                                         class="loan_popup">Appraisal</a></li>

                                                <?php
                                            }
                                            if ($row->sales_sl != '' || $row->sales_fs != '' || $row->sales_cf != '' || $row->sales_sl_fs != '') {
                                                ?>
                                                <li class="doc_grey"><a href="javascript:void(0);"
                                                                        onclick="popupCall('<?php echo $row->id . '/fedex/' . $condition; ?>')"
                                                                        class="fedex_popup">Fedex Labels</a></li>

                                                <?php
                                            }
                                            if ($row->sales_sl != '' || $row->sales_sl_fs != '' || $row->sales_fs != '' || $row->sales_sdira != '') {
                                                ?>
                                                <li class="<?php if ($row->doi_status == 'processing') {
                                                    echo 'doc_yellow';
                                                } elseif ($row->doi_status == 'complete') {
                                                    echo 'doc_green';
                                                } else {
                                                    echo 'doc_red';
                                                } ?>"><a href="javascript:void(0);"
                                                         onclick="popupCall('<?php echo $row->id . '/doi/' . $condition; ?>')"
                                                         class="doi_popup" <?php if ($row->sales_fs != '' || $row->sales_sl_fs != '') {
                                                        echo 'style="width:85px;"';
                                                    } ?>>DOI<?php if ($row->sales_fs != '' || $row->sales_sl_fs != '') {
                                            ...
                                            <li class="<?php if ($row->insurance_status == 'processing') {
                                                echo 'doc_yellow';
                                            } elseif ($row->insurance_status == 'complete') {
                                                echo 'doc_green';
                                            } else {
                                                echo 'doc_red';
                                            } ?>"><a href="javascript:void(0);"
                                                     onclick="popupCall('<?php echo $row->id . '/insurance/' . $condition; ?>')"
                                                     class="insurance_popup">Insurance</a></li>

                                            <li class="<?php if ($row->closed_status == 'processing') {
                                                echo 'doc_yellow';
                                            } elseif ($row->closed_status == 'complete') {
                                                echo 'doc_green';
                                            } else {
                                                echo 'doc_red';
                                            } ?>"><a href="javascript:void(0);"
                                                     onclick="popupCall('<?php echo $row->id . '/closed/' . $condition; ?>')"
                                                     class="closed_popup">Closing Docs</a></li>

                                            <li class="<?php if ($row->funded_status == 'processing') {
                                                echo 'doc_yellow';
                                            } elseif ($row->funded_status == 'complete') {
                                                echo 'doc_green';
                                            } else {
                                                echo 'doc_red';
                                            } ?>"><a href="javascript:void(0);"
                                                     onclick="popupCall('<?php echo $row->id . '/funded/' . $condition; ?>')"
                                                     class="fund_popup">Funded</a></li>

                                            <li class="<?php if ($row->hand_off_status == 'processing') {
                                                echo 'doc_yellow';
                                            } elseif ($row->hand_off_status == 'complete') {
                                                echo 'doc_green';
                                            } else {
                                                echo 'doc_red';
                                            } ?>"><a href="javascript:void(0);"
                                                     onclick="popupCall('<?php echo $row->id . '/hand_off/' . $condition; ?>')"
                                                     class="pmhand_popup">PM Hand Off</a></li>

                                            <li class="doc_grey"><a href="javascript:void(0);"
                                                                    onclick="popupCall('<?php echo $row->id . '/master/' . $condition; ?>')"
                                                                    class="master_popup">Master Notes</a></li>
                                            <li class="<?php if ($row->invoice_status == 'processing') {
                                                echo 'doc_yellow';
                                            } elseif ($row->invoice_status == 'complete') {
                                                echo 'doc_green';
                                            } else {
                                                echo 'doc_red';
                                            } ?>"><a href="javascript:void(0);"
                                                     onclick="popupCall('<?php echo $row->id . '/invoice/' . $condition; ?>')"
                                                     class="invoice_popup">Invoice</a></li>
                                            ...
                                            <?php if ($this->uri->segment(4) != 'completed' && $this->uri->segment(4) != 'cancelled' && $this->uri->segment(4) != 'swapped' && $this->session->userdata('ror_crm_session_admin_type') == '') {
                                                ?>
                                                <li class="doc_orange"><a href="javascript:void(0);" class="loi_popup "
                                                                          onclick="return confirmCancel('<?php echo $row->id; ?>')">Cancel</a>
                                                </li>
                                                <li class="doc_orange"><a href="javascript:void(0);" class="loi_popup "
                                                                          onclick="return confirmSwapped('<?php echo $row->id; ?>')">Swap</a>
                                                </li>
                                            ...
                                            if ($this->uri->segment(4) == 'completed') {
                                                if ($this->session->userdata('ror_crm_session_admin_type') == '') {
                                                    ?>
                                                    <li class="<?php if ($row->ror_iv_status == 'processing') {
                                                        echo 'doc_yellow';
                                                    } elseif ($row->ror_iv_status == 'complete') {
                                                        echo 'doc_green';
                                                    } else {
                                                        echo 'doc_red';
                                                    } ?>"><a href="javascript:void(0);"
                                                             onclick="popupCall('<?php echo $row->id . '/ror_iv/' . $condition; ?>')"
                                                             class="loi_popup">ROR Invoice</a></li>
                                                    <li class="<?php if ($row->gen_iv_status == 'processing') {
                                                        echo 'doc_yellow';
                                                    } elseif ($row->gen_iv_status == 'complete') {
                                                        echo 'doc_green';
                                                    } else {
                                                        echo 'doc_red';
                                                    } ?>"><a href="javascript:void(0);"
                                                             onclick="popupCall('<?php echo $row->id . '/gen_iv/' . $condition; ?>')"
                                                             class="loi_popup">Lead Gen Invoice</a></li>
                                                    <?php
                                                }
                                            } ?>

                                            <?php
                                        } elseif ($row->sales_sdira != '') {
                                            ?>
                                            ...
                                            <?php if ($row->sales_sl != '' || $row->sales_sl_fs != '') {
                                                ?>
                                                <li class="doc_grey"><a href="javascript:void(0);"
                                                                        onclick="popupCall('<?php echo $row->id . '/llc/' . $condition; ?>')"
                                                                        class="llc_popup">LLC</a></li>
                                            ...
                                            <?php if ($row->sales_sl != '' || $row->sales_sl_fs != '' || $row->sales_fs != '' || $row->sales_sdira != '') {
                                                ...
                                                <li class="<?php if ($row->doi_status == 'processing') {
                                                    ...
                                                    echo 'doc_red';
                                                         ...
                                                         onclick="popupCall('<?php echo $row->id . '/doi/' . $condition; ?>')"
                                                         class="doi_popup" <?php if ($row->sales_fs != '') {
                                                        echo 'style="width:85px;"';
                                        ...
                                        <?php if ($this->uri->segment(4) != 'completed' && $this->uri->segment(4) != 'cancelled' && $this->uri->segment(4) != 'swapped') {
                                            ...
                                            <li class="doc_grey">
                                                <a href="javascript:void(0);"
                                                   onclick="popupCall('<?php echo $row->id . '/create-alert/' . $condition; ?>')"
                                                   class="alert_popup">
                                                    Create Alert
                                                </a>
                                            </li>
