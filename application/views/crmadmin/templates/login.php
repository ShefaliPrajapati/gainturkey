...
<?php } ?>
		<?php echo form_open('crmadmin/adminlogin/admin_login'); if (strpos(base_url(),'pleasureriver.com') === false){ ?>
			...
			<ul class="login_opt_link">
				<li><a href="crmadmin/adminlogin/admin_forgot_password_form" class="tipLeft" title="Click to reset a new password">Forgot Password?</a></li>
