			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<?php 
						...
						echo form_open_multipart('crmadmin/productattribute/insertAttribute',$productattributes) 
					?>
						...
						<ul>
							...
							<div class="form_input">
								<input name="attr_name" id="attr_name" type="text" tabindex="1" class="required large tipTop" title="Please enter the property name"/>
							</div>
							</div>
							</li>
