...
class Seller extends MY_Controller {
     ...
     */
   	public function index(){	
		if ($this->checkLogin('CA') == ''){
			...
			redirect('crmadmin/seller/display_seller_dashboard');
		}
	}
	...
	public function display_seller_dashboard(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/seller/display_seller_dashboard',$this->data);
		}
	}
	...
	public function display_seller_requests(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/seller/display_seller_requests',$this->data);
		}
	}
	...
	public function display_seller_list(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/seller/display_sellerlist',$this->data);
		}
	}
	...
	public function change_seller_request(){
		if ($this->checkLogin('CA') == ''){
			...
			redirect('crmadmin/seller/display_seller_requests');
		}
	}
	...
	public function edit_seller_form(){
		if ($this->checkLogin('CA') == ''){
			...
			if ($this->data['seller_details']->num_rows() == 1 && $this->data['seller_details']->row()->group == 'Seller'){
				$this->load->view('crmadmin/seller/edit_seller',$this->data);
			}else {
				redirect('deals_crm');
			}
		}
	...
	public function view_seller(){
		if ($this->checkLogin('CA') == ''){
			...
			if ($this->data['seller_details']->num_rows() == 1){
				$this->load->view('crmadmin/seller/view_seller',$this->data);
			}else {
				redirect('deals_crm');
			}
		}
...
/* Location: ./application/controllers/crmadmin/seller.php */