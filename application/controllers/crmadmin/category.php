...
class Category extends MY_Controller {
	...
	public function index(){
		if ($this->checkLogin('CA') == ''){
			...
			redirect('crmadmin/category/display_category_list');
		}
	}
	...
	public function add_category_form(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/category/add_category',$this->data);
		}
	}
	/**
	 *
	...
	public function insertCategory(){
		if ($this->checkLogin('CA') == ''){
			...
			if ($duplicate_name->num_rows() > 0){
				...
				redirect('crmadmin/category/add_category_form/'.$cat_id);
			}
	...
	public function edit_category_form(){
		if ($this->checkLogin('CA') == ''){
			...
			if ($this->data['category_details']->num_rows() == 1){
				$this->load->view('crmadmin/category/edit_category',$this->data);
			}else {
				redirect('deals_crm');
			}
		}
	...
	public function view_category(){
		if ($this->checkLogin('CA') == ''){
			...
			if ($this->data['category_details']->num_rows() == 1){
				$this->load->view('crmadmin/category/view_category',$this->data);
			}else {
				redirect('deals_crm');
			}
		}
	...
	public function change_category_status_global(){
		...
		if($_POST['checkboxID']!=''){
			...
			if($_POST['checkboxID']=='0'){
				redirect('crmadmin/category/add_category_form/0');
			}else{
				redirect('crmadmin/category/add_category_form/'.$_POST['checkboxID']);
			}
	...
	public function display_banner_list(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/category/display_banner_list',$this->data);
		}
	}
	...
	public function add_banner_form(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/category/add_banner',$this->data);
		}
	}
	...
	public function insertBanner(){
		if ($this->checkLogin('CA') == ''){
			...
			if ( $this->upload->do_upload('banner_image')){
				...
				redirect('crmadmin/category/add_banner_form');
			}
			$category_data = array( 'image' => $ImageName);
			...
			redirect('crmadmin/category/display_banner_list');
		}
	}
	...
	public function edit_banner_form(){
		if ($this->checkLogin('CA') == ''){
			...
			if ($this->data['banner_details']->num_rows() == 1){
				$this->load->view('crmadmin/category/edit_banner',$this->data);
			}else {
				redirect('deals_crm');
			}
		}
...
/* Location: ./application/controllers/crmadmin/category.php */
