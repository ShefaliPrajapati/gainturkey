     ...
     */
   	public function index(){	
		if ($this->checkLogin('CA') == ''){
			...
			redirect('crmadmin/review/display_review_list');
		}
	}
...
//print_r($this->data['testimonialsList']);
			...
			$this->load->view('crmadmin/review/display_review',$this->data);
		}
	}
	...
	public function view_review(){
		if ($this->checkLogin('CA') == ''){
			...
			if ($this->data['review_details']->num_rows() == 1){
				$this->load->view('crmadmin/review/view_review',$this->data);
			}else {
				redirect('deals_crm');
			}
		}
