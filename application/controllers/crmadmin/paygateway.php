...
class Paygateway extends MY_Controller {
     ...
     */
   	public function index(){	
		if ($this->checkLogin('CA') == ''){
			...
			redirect('crmadmin/paygateway/display_gateway');
		}
	}
	...
	public function display_gateway(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/paygateway/display_gateway',$this->data);
		}
	}
	...
	public function edit_gateway_form(){
		if ($this->checkLogin('CA') == ''){
			...
			if ($this->data['gateway_details']->num_rows() == 1){
				$this->load->view('crmadmin/paygateway/edit_gateway',$this->data);
			}else {
				redirect('deals_crm');
			}
		}
...
/* Location: ./application/controllers/crmadmin/paygateway.php */