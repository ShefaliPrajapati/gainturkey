...
class Giftcards extends MY_Controller {
     ...
     */
   	public function index(){	
		if ($this->checkLogin('CA') == ''){
			...
			redirect('crmadmin/giftcards/display_giftcards');
		}
	}
	...
	public function display_giftcards(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/giftcards/display_giftcards',$this->data);
		}
	}
	...
	public function insertEditGiftcard(){
		if ($this->checkLogin('CA') == ''){
			...
			redirect('crmadmin/giftcards/edit_giftcards_settings');
		}
	}
	...
	public function edit_giftcards_settings(){
		if ($this->checkLogin('CA') == ''){
			...
			$this->load->view('crmadmin/giftcards/edit_giftcards_settings',$this->data);
		}
	}
...
/* Location: ./application/controllers/crmadmin/giftcards.php */
