...
class Multilanguage extends MY_Controller {
   ...
   function __construct()
	...
	function display_language_list()
	{
		...
		if ($this->checkLogin('CA') == ''){
			redirect('deals_crm');
				...
				$this->load->view('crmadmin/multilanguage/language_list',$this->data);
		}
	}
	...
	{	 
		...
		$this->data['admin_settings'] = $result = $this->admin_model->getAdminSettings();	
		$this->load->view('crmadmin/multilanguage/language_edit',$this->data);	
	...
	{					
			...
			redirect('crmadmin/multilanguage/display_language_list');
	}
	...
	public function add_new_lg(){
		if ($this->checkLogin('CA')==''){
			...
			$this->load->view('crmadmin/multilanguage/add_new_lg',$this->data);
		}
	}
