...
class Attribute extends MY_Controller {
	...
	public function display_attribute_list(){
		if ($this->checkLogin('A') == ''){
			...
			$this->data['heading'] = 'Code Details';
	...
	public function add_attribute_form(){
		if ($this->checkLogin('A') == ''){
			...
			$this->data['heading'] = 'Add New Code';
	...
	public function insertAttribute(){
		if ($this->checkLogin('A') == ''){
			...
			if ($duplicate_name->num_rows() > 0){
				$this->setErrorMessage('error','Code already exists');
			...
			$this->setErrorMessage('success','Code added successfully');
			redirect('admin/attribute/display_attribute_list');
		}
	}
	...
	public function EditAttribute(){
		if ($this->checkLogin('A') == ''){
			...
			$this->setErrorMessage('success','Code updated successfully');
			redirect('admin/attribute/display_attribute_list');
		}
	}
	...
	public function change_attribute_status(){
		if ($this->checkLogin('A') == ''){
			...
			$this->setErrorMessage('success','Code Status Changed Successfully');
			redirect('admin/attribute/display_attribute_list');
		}
	}
	...
	public function delete_attribute(){
		if ($this->checkLogin('A') == ''){
			...
			$this->setErrorMessage('success','Code deleted successfully');
			redirect('admin/attribute/display_attribute_list');
		}
	}
